function [u_nmpc, uopt, xopt, sopt, lopt, vopt, ocp_res] = ...
    nmpc(xhat, xtrg, ukm1, xkm1, skm1, lkm1, vkm1, args)
    %Nonlinear MPC by applying Sequential Quadratic Programming (SQP) by solving QP subsystems and
    ...
    nlp = args.nlp; % Functions required for Optimal Control Problem (OCP) implementation
